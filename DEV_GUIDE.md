...
| 项目 | 说明 |
|------|------|
| **上游仓库** | Wei-Shaw/NexusAPI |
| **Fork 仓库** | bayma888/NexusAPI-bmai |
...
| 数据库凭据 | user=`NexusAPI`, password=`NexusAPI`, dbname=`NexusAPI` |
...
psql -U NexusAPI -h 127.0.0.1 -d NexusAPI -f temp.sql
```
...
3. 无密码登录并重置
   ...
   ALTER USER NexusAPI WITH PASSWORD 'NexusAPI';
...
```bash
# 连接数据库
psql -U NexusAPI -h 127.0.0.1 -d NexusAPI
...
# 执行 SQL 文件
psql -U NexusAPI -h 127.0.0.1 -d NexusAPI -f migration.sql
```
...
- [上游仓库](https://github.com/Wei-Shaw/NexusAPI)
